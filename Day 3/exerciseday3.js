...
if (Modernizr.geolocation) {
 // supported
var imgKitten = document.createElement("img");
imgKitten.src = "https://placekitten.com/200/300";
var kitimg = document.getElementById("photo");
kitimg.append(imgKitten);
} else {
// not-supported
var imgpup = document.createElement("img");
imgpup.src = "http://www.placepuppy.net/1p/400/250";
var pupimg = document.getElementById("photo");
pupimg.append(imgpup);
}
